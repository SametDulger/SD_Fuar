...
namespace SD_Fuar.Models
{
    public class Sozlesme
    {
        ...
        [Required(ErrorMessage = "Sözleşme tipi zorunludur")]
        [StringLength(100, ErrorMessage = "Sözleşme tipi en fazla 100 karakter olabilir")]
        public string SozlesmeTipi { get; set; } = string.Empty;
        ...
        [StringLength(50, ErrorMessage = "İmza durumu en fazla 50 karakter olabilir")]
        public string ImzaDurumu { get; set; } = string.Empty;
        
        [Range(0, double.MaxValue, ErrorMessage = "Ücretsiz verilen metrekare 0'dan büyük olmalıdır")]
        public double UcretsizVerilenMetrekare { get; set; }
        
        public bool MudurOnayiGerekliMi { get; set; }
        
        [Required(ErrorMessage = "Son ödeme tarihi zorunludur")]
        public DateTime SonOdemeTarihi { get; set; }
        
        public ICollection<MuhasebeKaydi> MuhasebeKayitlari { get; set; } = new List<MuhasebeKaydi>();
    }
} 